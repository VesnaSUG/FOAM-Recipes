...
Here we defined a model for class <code>Recipe</code> that is in the <code>com.foamdev.cook</code> package and has three properties,
<code>id</code>, <code>name</code>, <code>description</code> and a few sample methods.
...
The other two properties, <code>name</code> and <code>description</code>, are of a string type and will be visible in the table view by default, as well as searchable. The model derives 
